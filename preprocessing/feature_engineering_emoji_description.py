...
combined_embedding_matrix_with_emoji_description = np.zeros((len(word_index) + 1, embedding_dim))
for word, i in word_index.items(): 
  combined_embedding_matrix_with_emoji_description[i] = glove_embedding_matrix[i]


print(f"Combined Embedding matrix shape: {combined_embedding_matrix_with_emoji_description.shape}")

np.save('../embeddings/combined_emedding_matrix_with_emoji_description.npy',combined_embedding_matrix_with_emoji_description)

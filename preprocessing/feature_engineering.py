...
# saving the combined embedding matrix
# combined_embedding_file_path = "../embeddings/combined_embedding_matrix.npy"
# np.save(combined_embedding_file_path, combined_embedding_matrix)
